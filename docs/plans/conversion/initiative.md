...
(plan1/plan2 closed as no-gos; plan3 is the #5a/#5b reading round — EWS +
MOPNS — and plan4 the AND-side half of #3; the ordering-guidance half of #2a
is parked behind both, its premise weakened by report2's budget-instability
observation).
