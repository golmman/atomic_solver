...
session, agile like `dfpn`/`lean`. The next plan number is **plan3**
(plan1 and plan2 both closed as Phase 0 no-gos; the surviving lever is
backlog #2's ordering-guidance half, re-ranked — see report2.md).
