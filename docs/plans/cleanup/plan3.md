...
git log --oneline -1            # expect 2bba249 on main
git fetch origin
```
...
machinery. Nothing needs to be re-created if the topic is ever revisited.
...
### Step 9 — Pick 11: `2bba249` (restore the cleanup prompt)
