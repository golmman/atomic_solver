...
- **plan6** — finalize twin preference (consistency → depth → more children →
  first created, sibling-chain counts) + replay-based Loss-completeness
  validator (#6), done (`report6.md`). Result: drift bit-identical (59/59
