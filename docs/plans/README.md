...
| [`parallel`](parallel/initiative.md)     | Parallel proof search (opt-in wall-time scaling)                     | #1 reading round (Čížek 2025, JLPNS, Young 2016) then the #2 architecture note; deterministic parallelism stays a measured no-go (lean plan7)  |
