...
| [`solve`](solve/initiative.md)           | Solve atomic chess from the starting position (verifiable proof artifact) | **pivoted 2026-09-22** to the Solved-Set Frontier Push (SSFP, proof-cost gradient) after plan1's RETHINK; plan2 drafted with the pre-registered M1 transposition-substrate gate (GO ≥5% / NO-GO <1%) and the 2 h pilot; backlog #2 closed, #3 rescoped |
