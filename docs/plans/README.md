...
| ---------------------------------------- | -------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| [`dfpn`](dfpn/initiative.md)             | Search semantics, algorithm-level node reduction (soundness-first)   | #6 gated small-space pre-phase (plan13 Phase 0 bake-off); #3 refinement after cap-cut; AND-side eval mass is threshold-cut frames (lean plan9 diagnostic) |
