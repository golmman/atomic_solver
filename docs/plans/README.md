...
| [`research`](research/initiative.md) | Research: reduce node count to first decisive outcome via problem inventory, literature scan, and quick POCs | #1 problem inventory; #2–#8 literature targets; #10–#13 POC candidates |
