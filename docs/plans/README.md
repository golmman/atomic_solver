...
| [`research`](research/initiative.md) | Re-scoped 2026-09-21 (pivot): from node-count reduction (program closed per plan8) to characterizing the structural floor — one consolidating no-go record | plan9: Deep df-pn 2017 desk mining (#15); then plan10: #16 `structural_floor.md` consolidation |
