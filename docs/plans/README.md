...
| [`research`](research/initiative.md) | Research: reduce node count to first decisive outcome via problem inventory, literature scan, and quick POCs | backlog exhausted (#1–#3, #5, #8, #10–#14 all answered/closed; #6/#7/#9 pre-weakened); plan8 recommends closing the node-count program — see `research/report8.md` |
